# server.py (updated to support station selection)
...
controller = get_controller(connection_str='tcp:127.0.0.1:5763', takeoff_height=5)
...
# (fly, return_home, run_mission_in_thread, index routes unchanged — keep same as before)
...
def run_mission_in_thread(waypoints):
    def mission():
        try:
            ...
            controller.fly_and_precision_land_with_waypoints(waypoints, loiter_alt=5, aruco_duration=60)
